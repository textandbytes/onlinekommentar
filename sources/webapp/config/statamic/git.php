...
return [
    ...
    */
    ...
    'paths' => [
        ...
        base_path('content/collections/commentaries'),
        base_path('content/collections/commentaries/de'),
        base_path('content/collections/commentaries/en'),
        base_path('content/collections/commentaries/fr'),
        base_path('content/collections/commentaries/it'),
        base_path('content/collections/legal_domains'),
        base_path('content/collections/legal_domains/en'),
        base_path('content/collections/pages'),
        base_path('content/collections/pages/de'),
        base_path('content/collections/pages/en'),
        base_path('content/collections/pages/fr'),
        base_path('content/collections/pages/it'),
        base_path('content/globals'),
        base_path('content/navigation'),
        base_path('content/taxonomies'),
        base_path('content/trees'),
        base_path('content/trees/collections'),
        base_path('content/trees/collections/de'),
        base_path('content/trees/collections/en'),
        base_path('content/trees/collections/fr'),
        base_path('content/trees/collections/it'),
