<template>
    <h1 class="text-2xl py-4 font-serif">Über uns</h1>
    <div class="text-lg prose">
        ...
        <p>Der Onlinekommentar möchte juristisches Fachwissen frei verfügbar machen (open access). Das bedeutet mit anderen Worten, dass der Onlinekommentar für immer frei und kostenlos zugänglich bleibt und insbesondere keine pay-wall eingerichtet wird. In den Vereinsstatuten ist dabei ausdrücklich festgehalten, dass der Verein keine kommerziellen Zwecke verfolgt und keinen Gewinn erstrebt (Ziff. 2 der Statuten). Der Onlinekommenter baut als Open-Access-Kommentar Zugangshürden ab. Er ermöglicht einen kostenlosen, einfachen, bequemen und niederschwelligen Zugang zu den Texten, auch für Personen ausserhalb der “legal community”.</p> 

        <p>Frei zugängliche Kommentare fördern den Wissensaustausch und bieten dem Kommentator eine höhere Sichtbarkeit seines Arbeitsresultats. Das Projekt Onlinekommentar soll auch ein Beitrag sein zu einer inklusiveren, diverseren, qualitativeren, moderneren, aktuelleren, interaktiveren und weniger hierarchischen Rechtswissenschaft und –praxis. Weitere Vorteile des Onlinekommentars finden Sie hier.</p>

        <p>Das Konzept des Onlinekommentars wurde vom Gründer in einem kürzlichen Artikel auf dem Verfassungsblog dargelegt.</p>
    </div>
