...
content:
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: ' Auf der Ebene des Bundes richteten sich die Vorschriften zum Turnen und Sport – wie auch das Schulsportobligatorium'
      -
        type: footnote
        attrs:
          data-content: '<p>Zum Schulsportobligatorium siehe Rz. 23–25 hiernach.</p>'
      -
        type: text
        text: " – noch bis in das Jahr 1970 lediglich an die Knaben und jungen Männer. Indessen hatten bis zum Zweiten Weltkrieg 15\_Kantone den Turnunterricht auch für die Mädchen und jungen Frauen für obligatorisch erklärt."
      -
        type: footnote
        attrs:
          data-content: '<p>Vgl. Zollinger, S. 38.</p>'
  -
    type: paragraph
    content:
      -
      ...
      -
        type: text
        text: ' sowie für ein Bundesgesetz über die Förderung von Turnen und Sport.'
      -
        type: footnote
        attrs:
          data-content: '<p>Vgl. CR-Adank, N. 2 f. zu Art. 68 BV; Botschaft 1971, S. 790 f.; Botschaft 1969, S. 1027 f.; Zollinger, S. 40&nbsp;f.</p>'
      -
        type: text
        text: " Der neue Art.\_27"
      -
        type: text
        marks:
          -
